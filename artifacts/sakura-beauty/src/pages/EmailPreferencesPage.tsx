// artifacts/sakura-beauty/src/pages/EmailPreferencesPage.tsx
...
updateSEO({ title: "Email Preferences", description: "Manage which emails you receive from EnvyEnhance." });
...
const PREF_META = [
  ...
  },
  {
    ...
    label: "Skincare Newsletter",
    description: "Tips, routines, ingredient guides and new product education.",
    icon: Bell,
    canDisable: true,
  },
  {
