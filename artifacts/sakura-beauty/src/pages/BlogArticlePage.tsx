...
const ARTICLES: Record<string, {
  ...
  "japanese-skincare-routine-beginners": {
    ...
    content: [
      ...
      { type: "p", text: "Unlike Western astringent toners, Japanese lotions (化粧水, keshōsui) are hydrating essences that prepare skin to absorb subsequent products. Pat a generous amount into skin with your palms — don't wipe. This step dramatically improves how your serums perform." },
