...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetReviewEligibilityQueryKey(productId);
   ...
   return  { queryKey, queryFn, enabled: !!(productId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getReviewEligibility>>, TError, TData> & { queryKey: QueryKey }
}
