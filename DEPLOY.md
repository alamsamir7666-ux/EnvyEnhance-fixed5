# 🚀 EnvyEnhance — Free Deployment Guide
...
1. Go to https://github.com/new and create a **private** repository named `envyenhance`
...
git branch -M main
git remote add origin https://github.com/YOUR-USERNAME/envyenhance.git
...
2. Click **New Project** → name it `envyenhance` → click **Create Project**
...
2. Click **Create Application** → name it `EnvyEnhance` → choose sign-in options → **Create**
...
3. Connect your GitHub account and select your `envyenhance` repository
4. Fill in the settings:
   - **Name:** `envyenhance-api`
...
5. Scroll to **Environment Variables** and add these one by one:
   ...
   | `ALLOWED_ORIGINS` | `https://envyenhance.vercel.app` *(update after Step 5)* |

6. Click **Create Web Service**
7. Wait for the build to finish (2–4 minutes)
8. Copy your API URL — it looks like `https://envyenhance-api.onrender.com`
...
2. Click **New Project** → import your `envyenhance` repository
3. Configure:
   - **Root Directory:** `artifacts/sakura-beauty`
